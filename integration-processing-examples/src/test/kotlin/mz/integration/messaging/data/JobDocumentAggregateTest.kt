...
import mz.integration.messaging.data.connector.redis.DataPlatformRedisConfiguration
import mz.integration.messaging.data.domain.JobDocument
import mz.integration.messaging.data.domain.JobDocumentAggregate
import mz.integration.messaging.data.domain.JobInfo
import mz.integration.messaging.data.domain.finished
import mz.integration.messaging.data.domain.toJobDocumentAggregate
