# ⚠️ ANTIPATTERN DEMO - DO NOT USE AS REFERENCE ⚠️

> **🚫 WARNING: This is INTENTIONAL BAD CODE**
>
...
- Not idempotent - retry → money transferred twice
...
`@RedisHash` annotations in domain model - swapping Redis → PostgreSQL requires 3-5 days and 20+ file changes.
